...
del batch['text']
del batch['label']
batch['input_ids'] = torch.tensor(batch['input_ids'], dtype=torch.long).unsqueeze(dim=0).cuda()
batch['token_type_ids'] = torch.tensor(batch['token_type_ids'], dtype=torch.long).unsqueeze(dim=0).cuda()
batch['attention_mask'] = torch.tensor(batch['attention_mask'], dtype=torch.long).unsqueeze(dim=0).cuda()
