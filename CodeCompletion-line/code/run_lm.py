...
def extract_neurons(self, input, output):
    ...
    for index in coordinates:
        if index[0] == layer_index:
            ...
            '''
            with open("/home/v-weixyan/Desktop/new/CodeXGLUE/Code-Code/CodeCompletion-line/code/size.txt","a") as file:
                file.write(str(output.shape))
                file.write("\n")
            #print()
            #print("dim", dim)
            '''
...
'''
        with open("/home/v-weixyan/Desktop/new/CodeXGLUE/Code-Code/CodeCompletion-line/code/activations.txt","a") as file:
