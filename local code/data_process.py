...
This program is used to convert data into a format that meets the requirements of codegpt, 
intercept half of the length as input, and generate ground truth.
