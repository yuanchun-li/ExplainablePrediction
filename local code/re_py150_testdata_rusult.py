...
This program is used to calculate the edit distance between the model prediction result and the ground truth,
 and search for the most similar code in mongdb.
...
db = client["re_py150_traindata_rusult"]
test_col = db["test"]
test_col.remove()
...
predictions_line = open("C:/Users/v-weixyan/Desktop/py150_train/train_pred.txt","r",encoding="utf-8")
predictions_line_list = predictions_line.readlines()
gt_line = open("C:/Users/v-weixyan/Desktop/py150_train/train_gt.txt","r",encoding="utf-8")
